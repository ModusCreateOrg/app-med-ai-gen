...
type MockedValidateFile = {
  mockReturnValue: (value: { isValid: boolean; errorKey?: string }) => void;
};
...
describe('useFileUpload hook', () => {
  ...
  beforeEach(() => {
    ...
    (uploadReport as unknown as MockedUploadReport).mockImplementation(
      (file: File, progressCallback?: UploadProgressCallback, _signal?: AbortSignal) => {
  ...
  test('should upload a file successfully', async () => {
    ...
    const { result } = renderHook(() => useFileUpload({ onUploadComplete: onUploadCompleteMock }));
